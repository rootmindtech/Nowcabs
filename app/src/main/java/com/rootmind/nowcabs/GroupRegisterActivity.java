...
public class GroupRegisterActivity extends AppCompatActivity implements  GroupRegisterAdapter.ItemClickListener  {

    public Toolbar toolbar;
    private static final String TAG = "GroupRegisterActivity";
    ...
    private GroupRegisterAdapter groupRegisterAdapter;
...
//        });
        ...
        groupRegisterAdapter = new GroupRegisterAdapter(groupRiderList);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(groupRegisterAdapter);
        groupRegisterAdapter.setClickListener(this);
        //----------------
        ...
        new GroupRegisterActivity.GroupProgressTask().execute();
...
//    {
//
//        GroupRegisterActivity.this.runOnUiThread(new Runnable() {
//
//            @Override
//            public void run() {
//
...
//                                groupRegisterAdapter.notifyDataSetChanged();
//
...
//                        } else {
//
//                            CommonService.Toast(GroupRegisterActivity.this, GlobalConstants.SYSTEM_ERROR, Toast.LENGTH_SHORT);
//
//                        }
//
//
...
//    }
    ...
    public void onClickDelete(View view, int position) {
        ...
        new GroupRegisterActivity.updatePublicProgressTask().execute(groupRider);
...
//                            CommonService.Toast(GroupRegisterActivity.this,"Please enter mobile number", Toast.LENGTH_SHORT);
//                            return;
//                        }
//
...
//                    messageJson.put("service", service);
            ...
            messageJson.put("linkRiderRefNo", rider.getRiderRefNo());
            messageJson.put("linkRiderID", rider.getRiderID());
